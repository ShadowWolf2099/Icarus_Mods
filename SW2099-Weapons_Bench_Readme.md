SW2099-Weapons_Bench_v1_w177_P.pak
----------------------------------------------------------------------
Mod Version: 1
...
## Description:
New Weapons Bench craftable in the character inventory.
 
## Mod Details:
- Complete weapons bench for the hunting enthusiasts!
- Has all the major firearms craftable in one place
