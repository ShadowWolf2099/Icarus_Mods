...
## Mod Details:
 Two Light Switches craftable on the character for free.
 White Light Switch controls light with the Electric Tool. It is its own power source.
   So wire your prospect just like a real electrician and control the light the way you want to.
 Tree Bark Light Switch controls all wall and floor torches any where on the map. so be careful to not burn down 
   your prospect. (No fuel needed)
