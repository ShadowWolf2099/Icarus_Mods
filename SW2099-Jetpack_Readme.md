...
## Mod Details:
- This mod only works in single mode. Hosted multiplayer & dedicated server not supported.
- A wearable custom Jetpack Backpack.
- When Activated you have the abilty to fly around Icarus with your very own backpack
